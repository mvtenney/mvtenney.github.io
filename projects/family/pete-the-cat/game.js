...
function addPlatforms() {
  ...
  platforms.create(250, 490, 'skateboard'); //skateboard
  platforms.create(25, 350, 'platform'); //grass
  platforms.create(400, 350, 'platform'); //grass
  platforms.create(675, 225, 'platform'); //grass
...
window.onload = function () {
  ...
  function preload() {
    ...
    game.load.image('skateboard', 'platform_2.png');
